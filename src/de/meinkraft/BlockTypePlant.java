...
public class BlockTypePlant extends BlockType {
	...
	public BlockTypePlant(boolean solid) {
		super(solid);
	}
	...
	public void addVertices(float x, float y, float z, FloatBuffer buffer, Blockcheck check, int... textures) {
		...
		if(!check.all()) {
			buffer.put(new float[] {
					x + 0, y + 0, z + 0,		0, 1, textures[0],
					x + 1, y + 0, z + 1,		1, 1, textures[0],
					x + 1, y + 1.4142f, z + 1,	1, 0, textures[0],
					x + 0, y + 1.4142f, z + 0,	0, 0, textures[0],
					...
					x + 0, y + 0, z + 1,		0, 1, textures[0],
					x + 1, y + 0, z + 0,		1, 1, textures[0],
					x + 1, y + 1.4142f, z + 0,	1, 0, textures[0],
					x + 0, y + 1.4142f, z + 1,	0, 0, textures[0],
